...
latex_documents = [
  ('index', 'SphinxRTDthemedemo.tex', u'Robo Support Documentation',
   u'Robo', 'manual'),
]
...
man_pages = [
    ('index', 'sphinxrtdthemedemo', u'Robo Support Documentation',
     [u'Robo'], 1)
]
...
texinfo_documents = [
  ('index', 'SphinxRTDthemedemo', u'Robo Support Documentation',
   u'Robo', 'SphinxRTDthemedemo', 'Documentation for Robo printers and software.',
   'Miscellaneous'),
]
