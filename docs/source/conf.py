...
latex_documents = [
  ('index', 'SphinxRTDthemedemo.tex', u'C2 User Manual',
   u'Robo', 'manual'),
]
...
man_pages = [
    ('index', 'sphinxrtdthemedemo', u'C2 User Manual',
     [u'Robo'], 1)
]
...
texinfo_documents = [
  ('index', 'SphinxRTDthemedemo', u'C2 User Manual',
   u'Robo', 'SphinxRTDthemedemo', 'Documentation for the C2 printer and software.',
   'Miscellaneous'),
]
